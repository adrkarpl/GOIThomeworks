...
![Alfred-sign](https://github.com/adrkarpl/GOITHomevork_pipenv/blob/main/pictures/Alfred.jpg)
...
![Alfred-show-all](https://github.com/adrkarpl/GOITHomevork_pipenv/blob/main/pictures/show_all.jpg)

Sample table of upcoming birthdays within a specified timeframe:
![Alfred-birthdays](https://github.com/adrkarpl/GOITHomevork_pipenv/blob/main/pictures/birthdays.jpg)

Sample table of notes:
![Alfred-show_notes](https://github.com/adrkarpl/GOITHomevork_pipenv/blob/main/pictures/show_notes.jpg)
...
1. **Clone the Repository:**
   ...
   - Clone this repository into a folder of choice on your local machine using the following command:
     ```
     git clone https://github.com/adrkarpl/GOITHomevork_pipenv
     ```
